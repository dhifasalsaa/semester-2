...
class Main {
    static Book[] bookList = {
            new Book(1, "Hujan", "Tere Liye", "Romance"),
            new Book(2, "Dilan 1991", "Pidi Baiq", "Romance"),
            new Book(3, "Piter CS", "Jurnal Risa", "Horor"),
            new Book(4, "Bumi Manusia", "Pramoedya Ananta Toer", "History"),
            new Book(5, "Negri 5 Menara", "Ahmad Fuadi", "Romance")
    };
...
class Student extends User {
    ...
    void borrowBook() {
        ...
        while (true) {
            System.out.println("======== Peminjaman Buku Perpustakaan UMM ========");
            displayBookList();
            System.out.println("Kembali");

            System.out.print("Input id buku yang ingin dipinjam (input untuk kembali): ");
